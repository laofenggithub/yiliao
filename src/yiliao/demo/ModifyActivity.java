        		...
        		new Button.OnClickListener(){
					...
					public void onClick(View v) {
        				...
        				for( int i=0; i<listAnswer.size(); i++ ){
        					String tempSave;
        					String[] strKind2=listAnswer.get(i).toString().trim().split(",");
    					...
    					getApplicationContext().sendBroadcast(new Intent("SearchFinish"));
					}
        		}
        );
...
//        }
        ...
        if( listQuestion.size() > 10 ){
	    	btChange[10].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 11 ){
	    	btChange[11].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 12 ){
	    	btChange[12].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 13 ){
	    	btChange[13].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 14 ){
	    	btChange[14].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 15 ){
	    	btChange[15].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 16 ){
	    	btChange[16].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 17 ){
	    	btChange[17].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 18 ){
	    	btChange[18].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 19 ){
	    	btChange[19].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 20 ){
	    	btChange[20].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 21 ){
	    	btChange[21].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 22 ){
	    	btChange[22].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 23 ){
	    	btChange[23].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 24 ){
	    	btChange[24].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 25 ){
	    	btChange[25].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 26 ){
	    	btChange[26].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 27 ){
	    	btChange[27].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 28 ){
	    	btChange[28].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 29 ){
	    	btChange[29].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 30 ){
	    	btChange[30].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 31 ){
	    	btChange[31].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 32 ){
	    	btChange[32].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 33 ){
	    	btChange[33].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 34 ){
	    	btChange[34].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 35 ){
	    	btChange[35].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 36 ){
	    	btChange[36].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 37 ){
	    	btChange[37].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 38 ){
	    	btChange[38].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 39 ){
	    	btChange[39].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
        ...
        if( listQuestion.size() > 40 ){
	    	btChange[40].setOnClickListener(
	        		new Button.OnClickListener(){
	        			@Override
						public void onClick(View v) {
    ...
    private void InitQuestion(int number,String question,SubYesNoButton button)
    {
        ...
        LinearLayout.LayoutParams lBtParams = new LinearLayout.LayoutParams(70,45);
