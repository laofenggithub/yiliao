...
//        HideStatusBar();
    	...
    	personname = confirmIntent.getStringExtra("personname").toString().trim();
        		...
        		new Button.OnClickListener(){
					...
					public void onClick(View v) {
        				...
        				if(kind.equals("1")){
        					...
        					String qCount = mapQuestion.get("subCounts").toString().trim();
        					tempAnswer += ",";
        					tempAnswer += qCount;
        		            for(int index=1; index <= Integer.parseInt(qCount); index++ ){
        		            	tempAnswer += ",";
        		                tempAnswer += mapAnswer.get("subAnswer"+index).toString().trim();
        		            }
