...
public class ModifyOneActivity extends Activity {
	...
	public class QuestionTextView extends TextView {
		...
		protected void onDraw(Canvas canvas) {
			...
			canvas.drawCircle(this.getWidth() - 40, this.getHeight() - 70, 40,
					paint);
			...
			canvas.drawRect(this.getWidth() - 80, 0, this.getWidth() - 40, 80,
					paint);
			canvas.drawRect(this.getWidth() - 80, 40, this.getWidth(), 80,
					paint);
			// left bottom
			canvas.drawCircle(40, this.getHeight() - 70, 36, paint);
			canvas.drawRect(0, this.getHeight() - 110, 80,
					this.getHeight() - 70, paint);
			canvas.drawRect(40, this.getHeight() - 70, 80,
					this.getHeight() - 30, paint);
			// right bottom
			canvas.drawCircle(this.getWidth() - 40, this.getHeight() - 70, 36,
					paint);
			canvas.drawRect(this.getWidth() - 80, this.getHeight() - 110,
					this.getWidth(), this.getHeight() - 70, paint);
			canvas.drawRect(this.getWidth() - 80, this.getHeight() - 110,
					this.getWidth() - 40, this.getHeight() - 30, paint);
			// draw top left right line
			paint.setColor(Color.rgb(66, 120, 185));
			canvas.drawLine(40, 0, this.getWidth() - 40, 0, paint);
			canvas.drawLine(0, 40, 0, this.getHeight() - 70, paint);
			canvas.drawLine(this.getWidth(), 40, this.getWidth(),
					this.getHeight() - 70, paint);
			// draw out triangle
			Path path = new Path();
			...
			canvas.drawLine(40, this.getHeight() - 31, 100,
					this.getHeight() - 31, paint);
			canvas.drawLine(200, this.getHeight() - 31, this.getWidth() - 40,
					this.getHeight() - 31, paint);
			...
			// draw in Rect
			canvas.drawRect(80, 4, this.getWidth() - 80, this.getHeight() - 33,
					paint);
			canvas.drawRect(4, 80, this.getWidth() - 4, this.getHeight() - 110,
					paint);
